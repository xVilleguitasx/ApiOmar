...
class InformacionTuristicaController {
    ...
    public async getOne(req: Request, res: Response): Promise<any> {
        const { id } = req.params;
        const games = await pool.query('SELECT * FROM informacion_turistica WHERE id = ?', [id]);
    ...
    public async create(req: Request, res: Response): Promise<void> {
        ...
        const result = await pool.query('INSERT INTO informacion_turistica set ?', [req.body]);
    ...
    public async update(req: Request, res: Response): Promise<void> {
        ...
        await pool.query('UPDATE informacion_turistica set ? WHERE id = ?', [req.body, id]);
